---
title: "Introduction to rIACI: Guidelines for the calculation of the Iberian Actuarial Climate Index"
author: "Nan Zhou"
date: "`r Sys.Date()`"
output:
...
In our paper [@Zhou2023], we follow the work of North American actuaries, [**Actuaries Climate Index<span>&trade;</span> (ACI)**](https://actuariesclimateindex.org/home/), and have created an index to show how climate changes in the Iberian Peninsula, which we named the Iberian Actuarial Climate Index. This guide provides detailed instructions on how to utilize the package for downloading, processing, and analyzing climate data to compute the Iberian Actuarial Climate Index (IACI).

# Table of Contents

1.  [Installation](#installation)
2.  [Getting Started](#getting-started)
3.  [Downloading ERA5-Land Data](#downloading-era5-land-data)
4.  [Processing Climate Data](#processing-climate-data)
5.  [Creating a Climate Input Object](#creating-a-climate-input-object)
6.  [Calculating Climate Indices](#calculating-climate-indices)
7.  [Integrating Sea Level Data](#integrating-sea-level-data)
8.  [Generating IACI Output](#generating-iaci-output)
9.  [Complete Workflow Example](#complete-workflow-example)
10. [Additional Resources](#additional-resources)

# Installation {#installation}

Since the **rIACI** package is not yet available on CRAN or GitHub, you can install it locally from the source. Ensure you have the necessary dependencies installed before proceeding.

```{r, eval=FALSE}
# Install required packages if not already installed
install.packages(c("devtools", "Rcpp", "reticulate", "dplyr", "tidyr", "lubridate", "magrittr", "ecmwfr"))

# Load devtools
library(devtools)

# Set your working directory to the location of the rIACI package source
setwd("path/to/rIACI") # Replace with the actual path

# Install the rIACI package locally
install()
```

# Getting Started After installation, load the package:

```{r, eval=FALSE}
library(rIACI)
```

The main workflow involves the following steps:
...
The `download_data()` function allows you to download ERA5-Land data from the ECMWF Climate Data Store.
...
# Download data for the year 2020
download_data(
  start_year = 2020,
  end_year = 2020,
  area = area_iberia,
